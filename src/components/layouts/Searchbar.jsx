        ...
        <Flex className="md:justify-between justify-center gap-x-2  items-center px-4 xl:px-0">
          ...
          <Flex className='md:w-1/5 md:gap-x-10 gap-x-2 justify-end'>
            ...
            <div className='relative flex items-center gap-x-8'>
              <BsCartFill onClick={() => setOpenCart(true)} className='cursor-pointer text-sm md:text-lg' />
            ...
            <div ref={cartRef} className={`lg:w-2/6 h-screen  bg-[#e3e3e3] duration-100 absolute top-0 z-40 right-0 origin-right ${openCart ? "rotate-x-0 " : "rotate-x-90  "}`}>
              <Flex className="justify-end pr-4 pt-4">
                <GrFormClose className='cursor-pointer' size={40} onClick={() => { setOpenCart(false) }} />
              </Flex>
                  ...
                  cartData.length > 0 ?
                    <>
                      ...
                      <Flex className="justify-center mt-5 lg:gap-x-5 gap-x-2">
                        <div className='lg:w-6/12' onClick={()=>setOpenCart(false)}>
                          <Link to="/checkout">
                        ...
                        <div className='lg:w-5/12' onClick={()=>setOpenCart(false)}>
                          <Link to="card">
